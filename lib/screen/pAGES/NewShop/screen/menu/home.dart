...
import 'package:pyramid/screen/pAGES/NewShop/model/categoryProductModel.dart';
...
import 'package:pyramid/screen/pAGES/NewShop/screen/product/addProduct.dart';
import 'package:pyramid/screen/pAGES/NewShop/screen/product/productDetail.dart';
import 'package:pyramid/screen/pAGES/NewShop/screen/product/searchProduct.dart';
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Text(
                                              "\₦"+"${price.format(x.sellingPrice)}",
                                              style: TextStyle(
                                                fontSize: 10,
                                                color: Color(0xFF034B3B)),
                                              ),
                                        ],
                                      ),
                                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        "${x.productName}",
                                        style:
                                            TextStyle(color: Color(0xFF5DB09E)),
                                      ),
                                      Text(
                                          "\₦ "+"${price.format(x.sellingPrice)}"),
                                    ],
