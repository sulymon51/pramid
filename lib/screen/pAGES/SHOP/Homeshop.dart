...
class MyshopHom extends StatefulWidget {
  @override
  _MyshopHomState createState() => _MyshopHomState();
}

class _MyshopHomState extends State<MyshopHom> {
  int _currentIndex;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("Phyramid Shop", style: headingStyle),
            ),
            SizedBox(
              height: 22,
            ),
