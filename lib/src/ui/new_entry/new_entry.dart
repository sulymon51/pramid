...
import 'package:pyramid/src/common/convert_time.dart';
import 'package:pyramid/src/global_bloc.dart';
import 'package:pyramid/src/models/errors.dart';
import 'package:pyramid/src/models/medicine.dart';
import 'package:pyramid/src/models/medicine_type.dart';
import 'package:pyramid/src/ui/homepage/homepage.dart';
import 'package:pyramid/src/ui/new_entry/new_entry_bloc.dart';
import 'package:pyramid/src/ui/success_screen/success_screen.dart';
...
class _NewEntryState extends State<NewEntry> {
  ...
  Future onSelectNotification(String payload) async {
    ...
    await Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => HomePageMedr()),
    );
  }
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xFF5DB09E),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? Color(0xFF5DB09E) : Colors.white,
            ),
            child: Center(
              child: Padding(
                ...
                const  IconData(0xe901, fontFamily: "Ic"),
                  size: 65,
                  color: isSelected ? Colors.white : Color(0xFF5DB09E),
                ),
              ),
            ),
          ),
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xFF5DB09E) : Colors.transparent,
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: Color(0xFF5DB09E)),
          ),
        ]),
      ),
    );
