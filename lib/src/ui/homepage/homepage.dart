...
import 'package:pyramid/src/ui/medicine_details/medicine_details.dart';
import 'package:pyramid/src/ui/new_entry/new_entry.dart';

 

class HomePageMedr extends StatefulWidget {
  @override
  _HomePageMedrState createState() => _HomePageMedrState();
}

class _HomePageMedrState extends State<HomePageMedr> {
  void initState() {
    super.initState();
  }
